...
% R = alphaV_1*varV_1 + alphaV_2*varV_2;
...
for trialIter = 1:numTrials
    ...
    for t = 1:N
        ...
        [mu_proposed(:, t+1), P_proposed{t+1}] = poposedEstimator(mu_proposed(:, t), P_proposed{t}, alphaV_1, muV_1, varV_1,...
            alphaV_2, muV_2, varV_2, C, A, y(:, t+1), Q);
...
% xlim('tight');
% ylim('tight');
% exportgraphics(f, 'fig_impulsive.pdf', 'ContentType','vector');
